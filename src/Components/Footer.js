    ...
    <div className="footer">
      ...
      <div className="lists">
        ...
        <div>
          <ul className="social">
            <p>Social</p>
            <a href="https://www.instagram.com/aesopskincare/">
              {" "}
              <li>Instagram ↗</li>{" "}
            </a>
            <a href="https://twitter.com/aesopskincare">
              {" "}
              <li>Twitter ↗</li>{" "}
            </a>
            <a href="https://www.linkedin.com/company/aesop">
              {" "}
              <li>LinkedIn ↗</li>{" "}
            </a>
          </ul>
